...
Keep in mind that you might have to prefix commands with `bunx` if nx isn't installed globally. Check the lockfile to determine the package manager in use.
