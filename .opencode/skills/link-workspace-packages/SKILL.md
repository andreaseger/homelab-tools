...
**Example 3: npm - link multiple packages**

```bash
npm install @org/data-access @org/ui --workspace @org/dashboard
```

**Example 4: Debug "Cannot find module"**
...
- **Hoisting differs by manager:**
  - bun: hoist shared deps to root `node_modules`
  - npm: hoist shared deps to root `node_modules`
