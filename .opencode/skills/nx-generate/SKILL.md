...
Note: Some generators don't support dry-run (e.g., if they install bun packages). If dry-run fails for this reason, proceed to running the generator for real.
